...
public static String hashPassword(String password) {
    ...
    private void initComponents() {
        ...
        jPanel3.add(verify, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 300, 130, 30));
        ...
        jPanel3.add(confirmpassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 250, 530, 30));

        oldpassword.setEditable(false);
        oldpassword.setText("asdasdsadadda");
        jPanel3.add(oldpassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, 530, 30));
        jPanel3.add(newpassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 170, 530, 30));

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 90, 610, 370));
